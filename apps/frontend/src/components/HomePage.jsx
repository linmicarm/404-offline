    ...
    <div>
      <div className="hero">
        <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
          ...
          >
            Game bars, boba, card shops, kawaii finds — the Atlanta nerd scene,
            between con season.
          </p>
          <div
            style={{
            ...
            {featuredQuest && (
              <div style={{ marginBottom: "2rem" }}>
                ...
                <div
                  style={{
                    background:
                      "linear-gradient(135deg, var(--peach-light) 0%, var(--bg) 100%)",
                  ...
                  onClick={() => {
                    setSelectedSideQuest(featuredQuest);
                    setCurrentPage("side-quest-detail");
                  }}
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.boxShadow =
                      "0 8px 32px rgba(255,170,127,0.2)")
                  }
                  onMouseLeave={(e) =>
                ...
                >
                  ...
                  >
                    ...
                    {featuredQuest.spawn_point && (
                      ...
                      >
                        📍 {featuredQuest.spawn_point.name} ·{" "}
                        {featuredQuest.spawn_point.neighborhood}
                      </span>
                    )}
                    <span
                      className="mono"
                      style={{ fontSize: "10px", color: "var(--ink-3)" }}
                    >
                      🗓 {formatDateShort(featuredQuest.date)} ·{" "}
                      {featuredQuest.time}
                    </span>
                  </div>
                </div>
