...
export default function SpawnPointsPage({ setCurrentPage, setSelectedSpawnPoint, setEditingSpawnPoint }) {
  ...
  async function handleDelete(id) {
    if (!window.confirm("Are you sure you want to delete this spawn point?")) return;
    try {
  ...
  return (
    <div className="page">
      <div className="page-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        ...
        <button className="btn-primary" onClick={() => setCurrentPage("spawn-point-form")}>
          + Add spawn point
        </button>
      </div>
