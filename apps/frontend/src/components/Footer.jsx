export default function Footer({ setCurrentPage }) {
  ...
  return (
    <>
      ...
      <button
        onClick={scrollToTop}
        style={{ position: "fixed", bottom: "2rem", right: "2rem", width: "44px", height: "44px", borderRadius: "50%", background: "var(--ink)", color: "var(--peach)", border: "1.5px solid var(--border)", cursor: "pointer", fontSize: "18px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 16px rgba(44,24,16,0.15)", transition: "transform 0.15s", zIndex: 50 }}
